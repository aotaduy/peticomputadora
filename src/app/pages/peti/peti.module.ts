...
@NgModule({
  declarations: [PetiComputerIdeComponent, InstructionsDisplayComponent, AssemblyEditorComponent, AssemblyRunnerComponent, InstructionComponent, AssemblyInstructionsHelpComponent, ExecutionDisplayComponent],
  imports: [
    ReactiveFormsModule,
    CommonModule,
    NbCardModule,
